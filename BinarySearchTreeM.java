...
import java.util.List;
 ...
 class BST
 {
    ...
    private BSTNode deleteTreeNode(BSTNode root, int data) {
        ...
        if(cur.data < data){     
            System.out.println("In > curr data : "+cur.data);     
            ...
            if(cur.left == null && cur.right == null){
                ...
                //change
                BSTNode temp  = findMaxFromLeft(cur.left);
                
                cur.data = temp.data;
                //change
                cur.left = deleteTreeNode(cur.left, temp.data);
            }
        }
    ...
    private BSTNode findMaxFromLeft(BSTNode node) {
        ...
        do    
        {
            ...
            case 1 : 
                System.out.println("Enter integer element to insert \n");
                    ...
                    System.out.println("Enter number of integer elements you are insering");
                    num = scan.nextInt();    
